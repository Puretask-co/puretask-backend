...
// ============================================
cleanerRouter.get("/reliability", (0, jwtAuth_1.requireRole)("cleaner"), async (req, res) => {
    try {
        const { getCleanerReliabilityInfo } = await Promise.resolve().then(() => __importStar(require("../services/reliabilityService")));
