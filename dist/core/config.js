...
exports.MATCHING_CONFIG = exports.AVAILABILITY_CONFIG = exports.FLEXIBILITY_CONFIG = exports.RESCHEDULE_CONFIG = exports.RELIABILITY_CONFIG = exports.CLIENT_RISK_CONFIG = exports.CANCELLATION_CONFIG = void 0;
// ============================================
// Cancellation System Configuration
// ============================================
exports.CANCELLATION_CONFIG = {
    grace: {
    ...
    feeSplits: {
        ...
        byWindow(window) {
            switch (window) {
                case '50%':
                    return { cleanerCompPct: 0.70, platformCompPct: 0.30 };
                case '100%':
                    return { cleanerCompPct: 0.80, platformCompPct: 0.20 };
                case 'free':
                default:
                    return { cleanerCompPct: 0, platformCompPct: 0 };
            }
        },
        clientNoShowCleanerCompPct: 0.90, // Cleaner gets 90% for client no-shows
        clientNoShowPlatformCompPct: 0.10,
    },
    bonusCredits: {
...
// ============================================
exports.RELIABILITY_CONFIG = {
    tiers: {
        developing: { min: 0, max: 59, name: 'Developing' },
        semiPro: { min: 60, max: 74, name: 'Semi Pro' },
        pro: { min: 75, max: 89, name: 'Pro' },
        elite: { min: 90, max: 100, name: 'Elite' },
    },
    windows: {
