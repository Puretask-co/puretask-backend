...
exports.computeRiskBand = computeRiskBand;
exports.computeReliabilityTier = computeReliabilityTier;
exports.clampScore = clampScore;
exports.computeReliabilityBasePoints = computeReliabilityBasePoints;
exports.getPayoutPercentForTier = getPayoutPercentForTier;
exports.getCreditRateRangeForTier = getCreditRateRangeForTier;
/**
 ...
 * 90-100: Elite
 */
function computeReliabilityTier(score) {
    if (score < 60)
        return 'Developing';
    if (score < 75)
        return 'Semi Pro';
 ...
 */
function computeReliabilityBasePoints(metrics) {
    const { totalJobsWindow, attendedJobs, onTimeCheckins, photoCompliantJobs, communicationOkJobs, completionOkJobs, ratingsSum, ratingsCount, } = metrics;
 ...
 * - Platinum (Elite): 85%
 */
function getPayoutPercentForTier(tier) {
    switch (tier) {
 ...
 * - Elite: 600-850
 */
function getCreditRateRangeForTier(tier) {
    switch (tier) {
