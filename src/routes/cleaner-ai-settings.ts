...
const updatePreferencesSchema = z.object({
  communicationTone: z.enum(['professional', 'friendly', 'professional_friendly', 'casual']).optional(),
  ...
  priorityGoal: z.enum(['maximize_bookings', 'quality_clients', 'balanced', 'work_life_balance']).optional(),
