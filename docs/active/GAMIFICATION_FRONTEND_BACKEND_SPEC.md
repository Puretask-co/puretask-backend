...
- [ ] **Cleaner progress:** GET `/cleaner/goals` with progress (current/target) and optionally GET `/cleaner/progress` or `/cleaner/progress/summary` with level, core %, stretch, maintenance, active_rewards.
